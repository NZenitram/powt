function loadCalender() {
  document.getElementById('main').innerHTML = `<div id="calender-text"><p><b>Missing your appointment because of time zone differences is considered a missed appointment. We are in the Mountain Standard Time Zone all year around. Check to make certain you know the difference in time before scheduling your appointment. If you are not familiar with time zones, please refer to the chart below.</b>
